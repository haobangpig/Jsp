			...
			<section id="content" class="column-right">         
				...
				<%
					if(counter==3&&key==1){
						...
						out.println("Excellent! <h2><a href="+"BBB_online_test_Java_questionLevel2Step3(Introduction).jsp"+">Keep Going  to the Step2</a></h2>");
					}else if(counter==2&&key==1){
						out.println("Nice Work! <h2><a href="+"BBB_online_test_Java_questionLevel2Step3(Introduction).jsp.jsp"+">Keep Going to the Step2</a></h2>");
					}else if((counter==4&&key==2)||(counter==5&&key==2)||(counter==6&&key==2)){
						out.println("Excellent! <h2><a href="+"BBB_online_test_Java_questionLevel2Step2(Introduction).jsp"+">Keep Going  to the Step2</a></h2>");
					}
					else{
						if((id==3&&key==1)||(id==6&&key==2)){
						out.println("Fail... <h2><a href="+"BBB_online_test_Java_questionStep2_recircle1(level2).jsp"+">try again</a></h2>");
						}else if((id==4&&key==1)||(id==7&&key==2)){
							out.println("Fail... <h2><a href="+"BBB_online_test_Java_questionStep2_recircle2(level2).jsp"+">try again</a></h2>");
							out.println(id);
