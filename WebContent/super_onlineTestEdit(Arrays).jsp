...
<%
	...
	<center>
	<%
				rs=sql.executeQuery("select * from BBB_test_Java_Arrays ");
	...
	<table border="6" width=60% cellpadding="10">
		...
		<tbody>
			<tr>
				...
				out.print("<td><a href='super_onlineTestEditPage(Arrays).jsp?user_id="+rs.getInt("id")+"'>Update</a></td>");
				out.print("</tr>");
				}
				...
				<p>Add new question ?
				<a href="super_onlineTestAddNewQuestion(Arrays).jsp">Click here</a></p>
					</center>
</body>
</html>