...
%>
	    ...
	    <article>
				<center>
					<form method="POST" action="BBB_edit_personal_information_success.jsp" name="form1" onSubmit="return on_submit()">
					<%
					...
					if(rs.next()){
						...
						<tbody>
							...
							<tr>
								<td>User_trueName:</td>
								<td><input name="user_trueName" value="<%=rs.getString("user_trueName")%>" /></td>	
							</tr>
							<tr>
								<td>User_gender</td>
								<td><input name="user_gender" value="<%=rs.getString("user_gender")%>" /></td>	
							</tr>
							<tr>
								<td>User_birthday</td>
								<td><input name="user_birth" value="<%=rs.getString("user_birth")%>" /></td>	
							</tr>
							<tr>
								<td>User_nationality</td>
								<td><input name="user_nation" value="<%=rs.getString("user_nation")%>" /></td>	
							</tr>
							<tr>
								<td>User_education</td>
								<td><input name="user_edu" value="<%=rs.getString("user_edu")%>" /></td>	
							</tr>
							<tr>
								<td>User_work</td>
								<td><input name="user_work" value="<%=rs.getString("user_work")%>" /></td>
							</tr>
							<tr>
								<td>User_phone</td>
								<td><input name="user_phone" value="<%=rs.getString("user_phone")%>" /></td>	
							</tr>
							<tr>
								<td>User_place</td>
								<td><input name="user_place" value="<%=rs.getString("user_place")%>" /></td>	
							</tr>
							<tr>
								<td>User_email</td>
								<td><input name="user_email" value="<%=rs.getString("user_email")%>" /></td>
							</tr>
							<tr>
