...
<%
				...
				String OneArray=(String)session.getAttribute("OneArray");
	
				String sql123="Update  BBB_test_Java_Array_AutoRunning set OneArray='"+OneArray+"' where username='"+userName+"' and id="+session.getAttribute("id_auto");
...
%>
			<article>
					...
					<form action="BBB_online_test_Java_Step2score.jsp" method="post" name="form2">
						<table>							
						<tbody>
