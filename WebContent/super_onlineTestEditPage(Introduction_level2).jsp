...
<%
		...
		String sqlString="select * from BBB_test_Java_Introduction_level2 where id="+user_id;
	...
	%>
<center>
	<form method="POST" action="super_onlineTestEditPage(Introduction_level2)_success.jsp" name="form1" onSubmit="return on_submit()">
