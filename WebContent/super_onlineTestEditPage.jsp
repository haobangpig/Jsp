...
<%
		...
		String sqlString="select * from BBB_test_Java where id="+user_id;
	...
	%>
<center>
	<form method="POST" action="super_onlineTestEditSuccess.jsp" name="form1" onSubmit="return on_submit()">
