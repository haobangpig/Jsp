...
<%
		...
		String sqlString="select * from BBB_test_Java_question where questionID="+questionID;
	...
	%>
<center>
	<form method="POST" action="super_questionEditPage_success.jsp" name="form1" onSubmit="return on_submit()">
		<table border="10" width=60% cellpadding="10">
			...
			<tr>
				<td>Catalogue</td>
				<td><input type="text" name="Catalogue" value="<%=rs.getString("Catalogue") %>"></td>
			</tr>
			<tr>
